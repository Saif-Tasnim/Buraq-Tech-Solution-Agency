        ...
        {blogs.map((blog) => (
          ...
          <li key={blog.id} className="border p-3">
            ...
            <div className="my-6">
              ...
              >
                <h2 className="text-lg font-semibold text-center">{blog.webTitle || "Frontend ReactJS: A guideline to be a developer"}</h2>
              </Link>
              <p className="text-sm mb-2 mt-7">
                Section: {blog.sectionName}
              </p>
